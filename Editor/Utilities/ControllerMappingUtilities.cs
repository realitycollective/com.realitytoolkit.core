...
namespace RealityToolkit.Editor.Utilities
{
    ...
    public static class ControllerMappingUtilities
    {
        ...
        /// <summary>
        /// Gets a texture based on the <see cref="ControllerProfile"/>.
        /// </summary>
        ...
        private static Texture2D GetControllerTextureCached(ControllerProfile mappingProfile, bool scaled = false)
        {
        ...
        private static Texture2D GetControllerTextureInternal(ControllerProfile mappingProfile, bool scaled)
        {
        ...
        private static bool TryGetControllerTextureFromProfile(ControllerProfile mappingProfile, bool scaled, out Texture2D texture)
        {
            texture = null;
