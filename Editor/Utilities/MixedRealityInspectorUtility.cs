    ...
    public static class MixedRealityInspectorUtility
    {
        ...
        public static Texture2D DarkThemeLogo
        {
            get
            {
                ...
                {
                    darkThemeLogo = (Texture2D)AssetDatabase.LoadAssetAtPath($"{PathFinderUtility.XRTK_Core_RelativeFolderPath}/Runtime/StandardAssets/Textures/RealityCollective_HorizontalLogo_1024.png", typeof(Texture2D));
                }
        ...
        public static Texture2D LightThemeLogo
        {
            get
            {
                ...
                {
                    lightThemeLogo = (Texture2D)AssetDatabase.LoadAssetAtPath($"{PathFinderUtility.XRTK_Core_RelativeFolderPath}/Runtime/StandardAssets/Textures/RealityCollective_HorizontalLogo_1024.png", typeof(Texture2D));
                }
