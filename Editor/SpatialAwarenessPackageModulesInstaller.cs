...
namespace RealityToolkit.Editor
{
    ...
    public sealed class SpatialAwarenessPackageModulesInstaller : IPackageModulesInstaller
    {
        ...
        {
            if (!typeof(IMixedRealitySpatialAwarenessServiceModule).IsAssignableFrom(serviceConfiguration.InstancedType.Type))
            {
            ...
            var typedServiceConfiguration = new ServiceConfiguration<IMixedRealitySpatialAwarenessServiceModule>(serviceConfiguration.InstancedType.Type, serviceConfiguration.Name, serviceConfiguration.Priority, serviceConfiguration.RuntimePlatforms, serviceConfiguration.Profile);
