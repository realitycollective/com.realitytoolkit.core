...
namespace RealityToolkit.Definitions.Controllers.Hands
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "Mixed Reality Toolkit/Input System/Hand Controller Pose", fileName = "HandControllerPose", order = (int)Utilities.CreateProfileMenuItemIndices.Input)]
