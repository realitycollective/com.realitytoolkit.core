...
{
    /// <summary>
    /// Base interface for implementing camera service modules to be registered with the <see cref="IMixedRealityCameraSystem"/>
    /// </summary>
    public interface IMixedRealityCameraServiceModule : IServiceModule
    {
        /// <summary>
        ...
        /// <summary>
        /// The <see cref="IMixedRealityCameraRig"/> reference for this service module.
        /// </summary>
