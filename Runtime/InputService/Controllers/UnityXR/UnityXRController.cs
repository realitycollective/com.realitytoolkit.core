...
namespace RealityToolkit.Input.Controllers.UnityXR
{
    /// <summary>
    ...
    public abstract class UnityXRController : BaseController
    {
        ...
        /// <inheritdoc />
        public UnityXRController(IControllerServiceModule controllerDataProvider, TrackingState trackingState, Handedness controllerHandedness, ControllerMappingProfile controllerMappingProfile)
        ...
        /// </summary>
        protected Pose SpatialGripPose { get; set; }
        ...
        protected virtual void UpdateDigitalInteractionMapping(InteractionMapping interactionMapping)
        {
        ...
        /// </summary>
        /// <param name="interactionMapping">The <see cref="InteractionMapping"/> to update.</param>
        protected virtual void UpdateSixDofInteractionMapping(InteractionMapping interactionMapping)
        {
        ...
        /// </summary>
        /// <param name="interactionMapping">The <see cref="InteractionMapping"/> to update.</param>
        protected virtual void UpdateSingleAxisInteractionMapping(InteractionMapping interactionMapping)
        {
        ...
        /// </summary>
        /// <param name="interactionMapping">The <see cref="InteractionMapping"/> to update.</param>
        protected virtual void UpdateDualAxisInteractionMapping(InteractionMapping interactionMapping)
        {
        ...
        protected void UpdateSpatialPointerPoseMapping(InteractionMapping interactionMapping)
        {
            Debug.Assert(interactionMapping.AxisType == AxisType.SixDof);
        ...
        protected void UpdateSpatialGripPoseMapping(InteractionMapping interactionMapping)
        {
            Debug.Assert(interactionMapping.AxisType == AxisType.SixDof);
