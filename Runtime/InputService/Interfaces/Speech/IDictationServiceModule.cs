...
namespace RealityToolkit.Input.Interfaces.Speech
{
    ...
    public interface IDictationServiceModule : IInputServiceModule
    {
        ...
        /// </summary>
        /// <param name="listener">GameObject listening for the dictation UnityEngine.Input.</param>
        ...
        /// <param name="autoSilenceTimeout">The time length in seconds before dictation recognizer session ends due to lack of audio UnityEngine.Input.</param>
