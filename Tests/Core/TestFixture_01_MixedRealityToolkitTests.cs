...
namespace XRTK.Tests.Core
{
    public class TestFixture_01_MixedRealityToolkitTests
    {
        ...
        public void Test_04_03_RegisterMixedRealityDataProviders()
        {
            ...
            var extensionServices = MixedRealityToolkit.GetActiveServices<IServiceDataProvider>();

            // Tests
            Assert.IsNotEmpty(extensionServices);
            Assert.IsTrue(activeSystemCount + 3 == MixedRealityToolkit.ActiveSystems.Count);
        }
        ...
        public void Test_04_04_UnregisterMixedRealityDataProvidersByType()
        {
            ...
            var dataProviders = MixedRealityToolkit.GetActiveServices<IServiceDataProvider>();
            ...
            // Tests
            Assert.IsTrue(successService, $"{nameof(ITestService)} was not found");
            Assert.IsFalse(successDataProvider1, $"{nameof(ITestDataProvider1)} was found when it should have been unregistered");
            Assert.IsFalse(successDataProvider2, $"{nameof(ITestDataProvider2)} was found when it should have been unregistered");
...
/*
        ...
        public void Test_05_03_RegisterMixedRealityExtensionServices()
        {
            ...
            Assert.IsTrue(activeSystemCount + extensionServices.Count == MixedRealityToolkit.ActiveSystems.Count);
        }
